...
function RenderRentRow({ rent, index, handleEndRent, handleEditRent, calculateRentStatus, setShowEditRent}) {
  ...
  return (
    <tr key={rent.id}>
      ...
      <td>
        ...
        <button className='btn btn-primary btn-sm ms-1' onClick={() => {handleEditRent(rent.id); setShowEditRent(true);}}>
