...
function RenderRentRow({ rent, index, handleEndRent, handleEditRent, calculateRentStatus}) {
  ...
  return (
    <tr key={rent.id}>
      ...
      <td>
        <button className='btn btn-primary btn-sm me-1' data-bs-toggle="modal" data-bs-target="#confirmDeleteMod" id={rent.id} onClick={() => handleEndRent(rent.id, rent.bookCode)}>
